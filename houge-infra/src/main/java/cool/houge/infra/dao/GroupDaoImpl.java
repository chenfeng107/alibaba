...
public class GroupDaoImpl implements GroupDao, GroupQueryDao {
  ...
  private final String INSERT_SQL =
      "INSERT INTO t_group(origin_gid,creator_uid,member_uids) VALUES($1,$2,$3)";
    ...
    return rc.use(
            spec ->
                spec.sql(INSERT_SQL)
                    ...
                    .bind("$2", m.getCreator().getId())
                    .bind("$3", m.getMemberUids().toArray(new Integer[] {}))
                ...
                spec.sql(GET_SQL)
                    ...
                    .fetch(
                        row -> {
                          ...
                          m.setCreator(new User().setId(row.get("creator_uid", Integer.class)));
