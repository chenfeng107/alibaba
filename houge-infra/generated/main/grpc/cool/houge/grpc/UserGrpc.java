...
public final class UserGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<cool.houge.grpc.UserPb.CreateUserRequest,
      cool.houge.grpc.UserPb.CreateUserResponse> getCreateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Create",
      requestType = cool.houge.grpc.UserPb.CreateUserRequest.class,
      responseType = cool.houge.grpc.UserPb.CreateUserResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<cool.houge.grpc.UserPb.CreateUserRequest,
      cool.houge.grpc.UserPb.CreateUserResponse> getCreateMethod() {
    io.grpc.MethodDescriptor<cool.houge.grpc.UserPb.CreateUserRequest, cool.houge.grpc.UserPb.CreateUserResponse> getCreateMethod;
    if ((getCreateMethod = UserGrpc.getCreateMethod) == null) {
      synchronized (UserGrpc.class) {
        if ((getCreateMethod = UserGrpc.getCreateMethod) == null) {
          UserGrpc.getCreateMethod = getCreateMethod =
              io.grpc.MethodDescriptor.<cool.houge.grpc.UserPb.CreateUserRequest, cool.houge.grpc.UserPb.CreateUserResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Create"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cool.houge.grpc.UserPb.CreateUserRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cool.houge.grpc.UserPb.CreateUserResponse.getDefaultInstance()))
  ...
  public static abstract class UserImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void create(cool.houge.grpc.UserPb.CreateUserRequest request,
        io.grpc.stub.StreamObserver<cool.houge.grpc.UserPb.CreateUserResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                cool.houge.grpc.UserPb.CreateUserRequest,
                cool.houge.grpc.UserPb.CreateUserResponse>(
  ...
  public static final class UserBlockingStub extends io.grpc.stub.AbstractBlockingStub<UserBlockingStub> {
    ...
    /**
     */
    public cool.houge.grpc.UserPb.CreateUserResponse create(cool.houge.grpc.UserPb.CreateUserRequest request) {
  ...
  public static final class UserFutureStub extends io.grpc.stub.AbstractFutureStub<UserFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<cool.houge.grpc.UserPb.CreateUserResponse> create(
        cool.houge.grpc.UserPb.CreateUserRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE:
          serviceImpl.create((cool.houge.grpc.UserPb.CreateUserRequest) request,
              (io.grpc.stub.StreamObserver<cool.houge.grpc.UserPb.CreateUserResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class UserBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return cool.houge.grpc.UserPb.getDescriptor();
    }
