...
@javax.annotation.Generated(
    ...
    comments = "Source: cool/houge/grpc/packet.proto")
public final class PacketGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<cool.houge.grpc.PacketPb.PacketRequest,
      cool.houge.grpc.PacketPb.PacketResponse> getProcessMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Process",
      requestType = cool.houge.grpc.PacketPb.PacketRequest.class,
      responseType = cool.houge.grpc.PacketPb.PacketResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<cool.houge.grpc.PacketPb.PacketRequest,
      cool.houge.grpc.PacketPb.PacketResponse> getProcessMethod() {
    io.grpc.MethodDescriptor<cool.houge.grpc.PacketPb.PacketRequest, cool.houge.grpc.PacketPb.PacketResponse> getProcessMethod;
      ...
      synchronized (PacketGrpc.class) {
        if ((getProcessMethod = PacketGrpc.getProcessMethod) == null) {
          PacketGrpc.getProcessMethod = getProcessMethod =
              io.grpc.MethodDescriptor.<cool.houge.grpc.PacketPb.PacketRequest, cool.houge.grpc.PacketPb.PacketResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Process"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cool.houge.grpc.PacketPb.PacketRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cool.houge.grpc.PacketPb.PacketResponse.getDefaultInstance()))
  ...
  public static abstract class PacketImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void process(cool.houge.grpc.PacketPb.PacketRequest request,
        io.grpc.stub.StreamObserver<cool.houge.grpc.PacketPb.PacketResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                cool.houge.grpc.PacketPb.PacketRequest,
                cool.houge.grpc.PacketPb.PacketResponse>(
  ...
  public static final class PacketBlockingStub extends io.grpc.stub.AbstractBlockingStub<PacketBlockingStub> {
     ...
     * </pre>
     */
    public cool.houge.grpc.PacketPb.PacketResponse process(cool.houge.grpc.PacketPb.PacketRequest request) {
  ...
  public static final class PacketFutureStub extends io.grpc.stub.AbstractFutureStub<PacketFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<cool.houge.grpc.PacketPb.PacketResponse> process(
        cool.houge.grpc.PacketPb.PacketRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PROCESS:
          serviceImpl.process((cool.houge.grpc.PacketPb.PacketRequest) request,
              (io.grpc.stub.StreamObserver<cool.houge.grpc.PacketPb.PacketResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class PacketBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return cool.houge.grpc.PacketPb.getDescriptor();
    }
