...
@javax.annotation.Generated(
    ...
    comments = "Source: cool/houge/grpc/communal/auth.proto")
public final class AuthGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<cool.houge.grpc.communal.AuthPb.AuthRequest,
      cool.houge.grpc.communal.AuthPb.AuthResponse> getAuthMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Auth",
      requestType = cool.houge.grpc.communal.AuthPb.AuthRequest.class,
      responseType = cool.houge.grpc.communal.AuthPb.AuthResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<cool.houge.grpc.communal.AuthPb.AuthRequest,
      cool.houge.grpc.communal.AuthPb.AuthResponse> getAuthMethod() {
    io.grpc.MethodDescriptor<cool.houge.grpc.communal.AuthPb.AuthRequest, cool.houge.grpc.communal.AuthPb.AuthResponse> getAuthMethod;
    if ((getAuthMethod = AuthGrpc.getAuthMethod) == null) {
      synchronized (AuthGrpc.class) {
        if ((getAuthMethod = AuthGrpc.getAuthMethod) == null) {
          AuthGrpc.getAuthMethod = getAuthMethod =
              io.grpc.MethodDescriptor.<cool.houge.grpc.communal.AuthPb.AuthRequest, cool.houge.grpc.communal.AuthPb.AuthResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Auth"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cool.houge.grpc.communal.AuthPb.AuthRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cool.houge.grpc.communal.AuthPb.AuthResponse.getDefaultInstance()))
  ...
  public static abstract class AuthImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void auth(cool.houge.grpc.communal.AuthPb.AuthRequest request,
        io.grpc.stub.StreamObserver<cool.houge.grpc.communal.AuthPb.AuthResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                cool.houge.grpc.communal.AuthPb.AuthRequest,
                cool.houge.grpc.communal.AuthPb.AuthResponse>(
                  this, METHODID_AUTH)))
          .build();
    }
  }
  ...
  public static final class AuthBlockingStub extends io.grpc.stub.AbstractBlockingStub<AuthBlockingStub> {
     ...
     * </pre>
     */
    public cool.houge.grpc.communal.AuthPb.AuthResponse auth(cool.houge.grpc.communal.AuthPb.AuthRequest request) {
  ...
  public static final class AuthFutureStub extends io.grpc.stub.AbstractFutureStub<AuthFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<cool.houge.grpc.communal.AuthPb.AuthResponse> auth(
        cool.houge.grpc.communal.AuthPb.AuthRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_AUTH:
          serviceImpl.auth((cool.houge.grpc.communal.AuthPb.AuthRequest) request,
              (io.grpc.stub.StreamObserver<cool.houge.grpc.communal.AuthPb.AuthResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AuthBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return cool.houge.grpc.communal.AuthPb.getDescriptor();
    }
