...
@javax.annotation.Generated(
    ...
    comments = "Source: cool/houge/grpc/message.proto")
public final class MessageGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<cool.houge.grpc.MessagePb.SendMessageRequest,
      cool.houge.grpc.MessagePb.SendMessageResponse> getSendToUserMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SendToUser",
      requestType = cool.houge.grpc.MessagePb.SendMessageRequest.class,
      responseType = cool.houge.grpc.MessagePb.SendMessageResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<cool.houge.grpc.MessagePb.SendMessageRequest,
      cool.houge.grpc.MessagePb.SendMessageResponse> getSendToUserMethod() {
    io.grpc.MethodDescriptor<cool.houge.grpc.MessagePb.SendMessageRequest, cool.houge.grpc.MessagePb.SendMessageResponse> getSendToUserMethod;
      ...
      synchronized (MessageGrpc.class) {
        if ((getSendToUserMethod = MessageGrpc.getSendToUserMethod) == null) {
          MessageGrpc.getSendToUserMethod = getSendToUserMethod =
              io.grpc.MethodDescriptor.<cool.houge.grpc.MessagePb.SendMessageRequest, cool.houge.grpc.MessagePb.SendMessageResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SendToUser"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cool.houge.grpc.MessagePb.SendMessageRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cool.houge.grpc.MessagePb.SendMessageResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<cool.houge.grpc.MessagePb.SendMessageRequest,
      cool.houge.grpc.MessagePb.SendMessageResponse> getSendToGroupMethod;
  ...
  public static io.grpc.MethodDescriptor<cool.houge.grpc.MessagePb.SendMessageRequest,
      cool.houge.grpc.MessagePb.SendMessageResponse> getSendToGroupMethod() {
    io.grpc.MethodDescriptor<cool.houge.grpc.MessagePb.SendMessageRequest, cool.houge.grpc.MessagePb.SendMessageResponse> getSendToGroupMethod;
  ...
  public static abstract class MessageImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sendToUser(cool.houge.grpc.MessagePb.SendMessageRequest request,
        io.grpc.stub.StreamObserver<cool.houge.grpc.MessagePb.SendMessageResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getSendToUserMethod(), responseObserver);
    }

    /**
     */
    public void sendToGroup(cool.houge.grpc.MessagePb.SendMessageRequest request,
        io.grpc.stub.StreamObserver<cool.houge.grpc.MessagePb.SendMessageResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                cool.houge.grpc.MessagePb.SendMessageRequest,
                cool.houge.grpc.MessagePb.SendMessageResponse>(
  ...
  public static final class MessageBlockingStub extends io.grpc.stub.AbstractBlockingStub<MessageBlockingStub> {
    ...
    /**
     */
    public cool.houge.grpc.MessagePb.SendMessageResponse sendToUser(cool.houge.grpc.MessagePb.SendMessageRequest request) {
    ...
    /**
     */
    public cool.houge.grpc.MessagePb.SendMessageResponse sendToGroup(cool.houge.grpc.MessagePb.SendMessageRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class MessageFutureStub extends io.grpc.stub.AbstractFutureStub<MessageFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<cool.houge.grpc.MessagePb.SendMessageResponse> sendToUser(
        cool.houge.grpc.MessagePb.SendMessageRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<cool.houge.grpc.MessagePb.SendMessageResponse> sendToGroup(
        cool.houge.grpc.MessagePb.SendMessageRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND_TO_USER:
          serviceImpl.sendToUser((cool.houge.grpc.MessagePb.SendMessageRequest) request,
              (io.grpc.stub.StreamObserver<cool.houge.grpc.MessagePb.SendMessageResponse>) responseObserver);
          break;
        case METHODID_SEND_TO_GROUP:
          serviceImpl.sendToGroup((cool.houge.grpc.MessagePb.SendMessageRequest) request,
              (io.grpc.stub.StreamObserver<cool.houge.grpc.MessagePb.SendMessageResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class MessageBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return cool.houge.grpc.MessagePb.getDescriptor();
    }
