...
import static cool.houge.grpc.PacketGrpc.getServiceDescriptor;
...
public final class ReactorPacketGrpc {
    ...
    public static final class ReactorPacketStub extends io.grpc.stub.AbstractStub<ReactorPacketStub> {
         ...
         * </pre>
         */
        public reactor.core.publisher.Mono<cool.houge.grpc.PacketPb.PacketResponse> process(reactor.core.publisher.Mono<cool.houge.grpc.PacketPb.PacketRequest> reactorRequest) {
         ...
         * </pre>
         */
        public reactor.core.publisher.Mono<cool.houge.grpc.PacketPb.PacketResponse> process(cool.houge.grpc.PacketPb.PacketRequest reactorRequest) {
    ...
    public static abstract class PacketImplBase implements io.grpc.BindableService {
         ...
         * </pre>
         */
        public reactor.core.publisher.Mono<cool.houge.grpc.PacketPb.PacketResponse> process(reactor.core.publisher.Mono<cool.houge.grpc.PacketPb.PacketRequest> request) {
        ...
        @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
            return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
                    .addMethod(
                            cool.houge.grpc.PacketGrpc.getProcessMethod(),
                            asyncUnaryCall(
                                    new MethodHandlers<
        ...
        public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch (methodId) {
                case METHODID_PROCESS:
                    com.salesforce.reactorgrpc.stub.ServerCalls.oneToOne((cool.houge.grpc.PacketPb.PacketRequest) request,
