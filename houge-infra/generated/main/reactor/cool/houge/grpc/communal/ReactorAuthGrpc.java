...
import static cool.houge.grpc.communal.AuthGrpc.getServiceDescriptor;
...
public final class ReactorAuthGrpc {
    ...
    public static final class ReactorAuthStub extends io.grpc.stub.AbstractStub<ReactorAuthStub> {
         ...
         * </pre>
         */
        public reactor.core.publisher.Mono<cool.houge.grpc.communal.AuthPb.AuthResponse> auth(reactor.core.publisher.Mono<cool.houge.grpc.communal.AuthPb.AuthRequest> reactorRequest) {
         ...
         * </pre>
         */
        public reactor.core.publisher.Mono<cool.houge.grpc.communal.AuthPb.AuthResponse> auth(cool.houge.grpc.communal.AuthPb.AuthRequest reactorRequest) {
    ...
    public static abstract class AuthImplBase implements io.grpc.BindableService {
         ...
         * </pre>
         */
        public reactor.core.publisher.Mono<cool.houge.grpc.communal.AuthPb.AuthResponse> auth(reactor.core.publisher.Mono<cool.houge.grpc.communal.AuthPb.AuthRequest> request) {
        ...
        @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
            return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
                    .addMethod(
                            cool.houge.grpc.communal.AuthGrpc.getAuthMethod(),
                            asyncUnaryCall(
                                    new MethodHandlers<
    ...
    private static final class MethodHandlers<Req, Resp> implements
        ...
        public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch (methodId) {
                case METHODID_AUTH:
                    com.salesforce.reactorgrpc.stub.ServerCalls.oneToOne((cool.houge.grpc.communal.AuthPb.AuthRequest) request,
