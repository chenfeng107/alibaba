...
import static cool.houge.grpc.MessageGrpc.getServiceDescriptor;
...
public final class ReactorMessageGrpc {
    ...
    public static final class ReactorMessageStub extends io.grpc.stub.AbstractStub<ReactorMessageStub> {
         ...
         * </pre>
         */
        public reactor.core.publisher.Mono<cool.houge.grpc.MessagePb.SendMessageResponse> sendToUser(reactor.core.publisher.Mono<cool.houge.grpc.MessagePb.SendMessageRequest> reactorRequest) {
         ...
         * </pre>
         */
        public reactor.core.publisher.Mono<cool.houge.grpc.MessagePb.SendMessageResponse> sendToGroup(reactor.core.publisher.Mono<cool.houge.grpc.MessagePb.SendMessageRequest> reactorRequest) {
         ...
         * </pre>
         */
        public reactor.core.publisher.Mono<cool.houge.grpc.MessagePb.SendMessageResponse> sendToUser(cool.houge.grpc.MessagePb.SendMessageRequest reactorRequest) {
         ...
         * </pre>
         */
        public reactor.core.publisher.Mono<cool.houge.grpc.MessagePb.SendMessageResponse> sendToGroup(cool.houge.grpc.MessagePb.SendMessageRequest reactorRequest) {
    ...
    public static abstract class MessageImplBase implements io.grpc.BindableService {
         ...
         * </pre>
         */
        public reactor.core.publisher.Mono<cool.houge.grpc.MessagePb.SendMessageResponse> sendToUser(reactor.core.publisher.Mono<cool.houge.grpc.MessagePb.SendMessageRequest> request) {
         ...
         * </pre>
         */
        public reactor.core.publisher.Mono<cool.houge.grpc.MessagePb.SendMessageResponse> sendToGroup(reactor.core.publisher.Mono<cool.houge.grpc.MessagePb.SendMessageRequest> request) {
            throw new io.grpc.StatusRuntimeException(io.grpc.Status.UNIMPLEMENTED);
        }
        ...
        @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
            return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
                    .addMethod(
                            cool.houge.grpc.MessageGrpc.getSendToUserMethod(),
                            asyncUnaryCall(
                                    new MethodHandlers<
                    ...
                    .addMethod(
                            cool.houge.grpc.MessageGrpc.getSendToGroupMethod(),
                            asyncUnaryCall(
                                    new MethodHandlers<
                                            cool.houge.grpc.MessagePb.SendMessageRequest,
                                            cool.houge.grpc.MessagePb.SendMessageResponse>(
        ...
        public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch (methodId) {
                case METHODID_SEND_TO_USER:
                    com.salesforce.reactorgrpc.stub.ServerCalls.oneToOne((cool.houge.grpc.MessagePb.SendMessageRequest) request,
