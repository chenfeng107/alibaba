...
public final class ReactorUserGrpc {
    ...
    public static final class ReactorUserStub extends io.grpc.stub.AbstractStub<ReactorUserStub> {
         ...
         * </pre>
         */
        public reactor.core.publisher.Mono<cool.houge.grpc.UserPb.CreateUserResponse> create(reactor.core.publisher.Mono<cool.houge.grpc.UserPb.CreateUserRequest> reactorRequest) {
         ...
         * </pre>
         */
        public reactor.core.publisher.Mono<cool.houge.grpc.UserPb.CreateUserResponse> create(cool.houge.grpc.UserPb.CreateUserRequest reactorRequest) {
    ...
    public static abstract class UserImplBase implements io.grpc.BindableService {
         ...
         * </pre>
         */
        public reactor.core.publisher.Mono<cool.houge.grpc.UserPb.CreateUserResponse> create(reactor.core.publisher.Mono<cool.houge.grpc.UserPb.CreateUserRequest> request) {
        ...
        public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch (methodId) {
                case METHODID_CREATE:
                    com.salesforce.reactorgrpc.stub.ServerCalls.oneToOne((cool.houge.grpc.UserPb.CreateUserRequest) request,
