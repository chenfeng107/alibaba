...
public final class BrokerGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<cool.houge.grpc.broker.BrokerPb.AttachRequest,
      cool.houge.grpc.broker.BrokerPb.AttachResponse> getAttachMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Attach",
      requestType = cool.houge.grpc.broker.BrokerPb.AttachRequest.class,
      responseType = cool.houge.grpc.broker.BrokerPb.AttachResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<cool.houge.grpc.broker.BrokerPb.AttachRequest,
      cool.houge.grpc.broker.BrokerPb.AttachResponse> getAttachMethod() {
    io.grpc.MethodDescriptor<cool.houge.grpc.broker.BrokerPb.AttachRequest, cool.houge.grpc.broker.BrokerPb.AttachResponse> getAttachMethod;
      ...
      synchronized (BrokerGrpc.class) {
        if ((getAttachMethod = BrokerGrpc.getAttachMethod) == null) {
          BrokerGrpc.getAttachMethod = getAttachMethod =
              io.grpc.MethodDescriptor.<cool.houge.grpc.broker.BrokerPb.AttachRequest, cool.houge.grpc.broker.BrokerPb.AttachResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Attach"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cool.houge.grpc.broker.BrokerPb.AttachRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cool.houge.grpc.broker.BrokerPb.AttachResponse.getDefaultInstance()))
  ...
  public static abstract class BrokerImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void attach(cool.houge.grpc.broker.BrokerPb.AttachRequest request,
  ...
  public static final class BrokerBlockingStub extends io.grpc.stub.AbstractBlockingStub<BrokerBlockingStub> {
    ...
    /**
     */
    public java.util.Iterator<cool.houge.grpc.broker.BrokerPb.AttachResponse> attach(
        cool.houge.grpc.broker.BrokerPb.AttachRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ATTACH:
          serviceImpl.attach((cool.houge.grpc.broker.BrokerPb.AttachRequest) request,
              (io.grpc.stub.StreamObserver<cool.houge.grpc.broker.BrokerPb.AttachResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class BrokerBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return cool.houge.grpc.broker.BrokerPb.getDescriptor();
    }
